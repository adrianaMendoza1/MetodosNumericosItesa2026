...
* [Cálculo de Errores Base](./Ejemplo.py)

![Ejecución Cálculo de Errores Base](../img/T1_Ejemplo.png)

### ### Ejemplos Prácticos
* [Ejemplo 1: Error de Redondeo](./Ejemplo1.py)

![Ejecución Ejemplo 1](../img/T1_Ejemplo1.png)

* [Ejemplo 2: Error de Truncamiento (Serie de Taylor)](./Ejemplo2.py)

![Ejecución Ejemplo 2](../img/T1_Ejemplo2.png)

* [Ejemplo 3: Precisión de Máquina (Épsilon)](./Ejemplo3.py)

![Ejecución Ejemplo 3](../img/T1_Ejemplo3.png)

* [Ejemplo 4: Error en Operaciones Aritméticas](./Ejemplo4.py)

![Ejecución Ejemplo 4](../img/T1_Ejemplo4.png)

* [Ejemplo 5: Conversión Decimal a Binario](./Ejemplo5.py)
